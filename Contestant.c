//Program for the contestant module
#include<stdio.h> 
#include<stdlib.h>
#include<string.h>
#include"header.h"
	...
	while(1)
	{
		...
		switch(ch)
		{
			...
			case 2: 
				...
				break ;
			case 3: 
				//To continue the quiz if he left in the middle
				printf("enter the user-id \n");
				scanf("%s",user_id);
				printf("enter the password\n");
				scanf("%s",pswd);
				...
				break ;
			case 4: 
				//Checking the scores of the contestant
...
//Creating the list of the contestants
...
//Extraction of the data from the contestant file

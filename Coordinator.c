//Program for the coordinator module
#include<stdio.h>
#include<string.h>
#include<stdlib.h>
#include"header.h"
...
void Coordinator()
{
	...
	char *quize_file = "round1.txt";
	char *quize_file_2 = "round2.txt";
	design();
	...
	while(1)
	{
		...
		switch(ch)
		{
			...
			case 3: 
				...
				scanf("%d",&ch);
				//entering into round 1 questions
				if(ch == 1)
				{
				...
				//entering into round 2 questions
				else if(ch == 2)
				{
					printf("enter the question \n");
					getchar();
				...
				break ;
			case 4: //deletion of quiz
			case 5:
				//displaying questions for round 1 and round2
				printf("enter 1 for first round\n");
				printf("enter 2 for second round\n");
				scanf("%d",&ch);
				if(ch == 1)
...
//Extracting the questions from file
...
//Creation of the list for question answers

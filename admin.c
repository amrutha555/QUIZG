				...
				while(1)
				{
					...
					switch(ch)
					{
						case 1:
							...
							break;
						case 2:
							//Updating the coordinator details
						...
						case 3:
							...
							break;
						case 4:
							//Displaying the list of coordinator
...
//Extracting the data of coordinator from file
...
//Saving the data of coordinator into file
...
//Displaying the list of coordinator details
...
//To give the length of the list of the coordinator
...
//Deletion of the existing coordinator
...
//Deletion of the contestant
void delete_contestant()
{
	printf("delete_contestant \n");	
}
//View the contestant details
